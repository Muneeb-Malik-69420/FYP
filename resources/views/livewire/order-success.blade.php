<div class="min-h-screen bg-[#F9FAFB] flex flex-col items-center justify-start py-16 px-4 animate-fadeIn">
    ...
    <div class="flex flex-col items-center text-center mb-10">
        ...
        <div class="relative w-20 h-20 mb-6">
            <div class="absolute inset-0 bg-[#52c234]/10 rounded-full animate-ping-slow"></div>
            <div class="relative w-full h-full bg-[#52c234] rounded-full flex items-center justify-center shadow-lg shadow-green-300/40">
        ...
        <h1 class="text-3xl font-black text-gray-900 tracking-tight">Order Confirmed!</h1>
    ...
    <div class="w-full max-w-xl">
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            {{-- Receipt header --}}
            <div class="bg-[#F0FDF4] px-8 py-5 border-b border-green-100 flex items-center justify-between">
                <div>
            ...
            <div class="px-8 py-6 space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <span class="inline-flex items-center gap-1.5 bg-green-100 text-[#437836] text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full">
                        ...
                        @foreach($order->items as $item)
                            <div class="flex items-center justify-between gap-4">
                                <div class="flex items-center gap-3 min-w-0">
                                    <span class="shrink-0 w-6 h-6 bg-[#52c234]/10 text-[#437836] text-[10px] font-black rounded-full flex items-center justify-center">
                                        {{ $item->quantity }}
                                    </span>
                ...
                <div class="relative -mx-8">
                    <div class="flex items-center">
                        <div class="w-5 h-5 bg-[#F9FAFB] rounded-full shrink-0"></div>
                        <div class="flex-1 border-t-2 border-dashed border-gray-100 mx-1"></div>
                        <div class="w-5 h-5 bg-[#F9FAFB] rounded-full shrink-0"></div>
                    </div>
                </div>
            ...
            <div class="px-8 pb-8 flex flex-col items-center gap-4">
                ...
                <button wire:click="goHome"
                        class="w-full bg-black hover:bg-[#52c234] text-white py-4 rounded-2xl font-bold
