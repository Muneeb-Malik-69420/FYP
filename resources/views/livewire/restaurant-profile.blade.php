            ...
            <div class="absolute bottom-10 left-0 w-full">
                ...
                <div class="max-w-7xl mx-auto px-6">
                    ...
                    <nav class="flex items-center gap-3 mb-6 text-white/60">
                        ...
                        <span
                            class="text-[10px] font-black uppercase tracking-[0.2em] text-white/90">{{ $supplier->business_name }}</span>
                    ...
                    <div class="flex items-end justify-between gap-6">
                        ...
                        <div class="text-white">
                            ...
                            <h1
                                class="text-5xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-6 italic">
                            ...
                            <div class="flex flex-wrap items-center gap-6">
                                ...
                                <div class="flex items-center gap-2 bg-[#52c234] px-3 py-1 rounded-sm shadow-lg">
                                    ...
                                    <span
                                        class="text-[9px] font-black uppercase tracking-widest text-white">Eco-Partner</span>

                                </div>

                                <div
                                    class="flex items-center gap-2 text-[11px] font-bold uppercase tracking-widest text-white/90">
                        ...
                        <button
                            class="bg-white text-black h-16 w-16 rounded-full flex items-center justify-center shadow-2xl hover:bg-red-500 hover:text-white transition-all transform hover:scale-110 group">
                ...
                <nav class="flex items-center gap-8 overflow-x-auto no-scrollbar scroll-smooth">
                    ...
                    @foreach (['All Deals', 'Flash Sales', 'Combos', 'Weekly Specials', 'First Order'] as $category)
                        <a href="#"
                            ...
                            <span
                                class="absolute -bottom-[21px] left-0 w-0 h-0.5 bg-black transition-all group-hover:w-full"></span>
        ...
        <div class="bg-[#ececec]">
            ...
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="flex flex-col lg:flex-row items-start">
                    ...
                    <div
                        class="w-full lg:flex-grow lg:pr-12 pt-8 pb-20 lg:h-[calc(100vh-120px)] lg:overflow-y-auto custom-scrollbar">
                        ...
                        <div id="deals-container" class="mb-16">
                            ...
                            <h2
                                class="text-[11px] font-black uppercase tracking-[0.4em] text-gray-900 mb-8 flex items-center gap-4">
                        ...
                        <div class="h-full py-8 lg:pl-12 lg:border-l lg:border-gray-300 flex flex-col">
                            ...
                            <div class="bg-white border border-gray-300 p-8 shadow-sm flex flex-col h-full">
                                ...
                                <div class="flex items-center justify-between mb-8 border-b border-gray-100 pb-5">
                                    ...
                                    <h2 class="text-[11px] font-black uppercase tracking-[0.3em] text-gray-900">Your
                                        Basket</h2>
                                ...
                                <div class="flex-grow overflow-y-auto no-scrollbar mb-6">
                                    ...
                                    <div
                                        class="py-12 text-center border border-dashed border-gray-200 mb-8 bg-[#f9f9f9]">

                                        <p class="text-[9px] font-black uppercase tracking-widest text-gray-400">Basket
                                            is empty</p>
                                ...
                                <div class="mt-auto pt-5 border-t border-gray-100">
                                    ...
                                    <div
                                        class="flex justify-between text-lg font-black uppercase tracking-tighter text-gray-900 mt-2">
                                    ...
                                    <button
                                        class="w-full bg-black text-white mt-10 py-5 text-[10px] font-black uppercase tracking-[0.3em] hover:bg-[#52c234] transition-all">
